...
namespace Karma
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            comboMenu.Add("MantraMode", new ComboBox("Mantra Priority", 0, "Q", "W", "E", "Auto"));
            comboMenu.AddLabel("Q : uses R + Q on target");
            comboMenu.AddLabel("W : uses R + W on target");
            comboMenu.AddLabel("E : uses R + E on Self");
            comboMenu.AddSeparator();
            comboMenu.Add("Mantra", new KeyBind("Change Priority", false, KeyBind.BindTypes.HoldActive, 'T'));


            harassMenu = Menu.AddSubMenu("Harass", "Harass");
            harassMenu.Add("HarassQ1", new CheckBox("Use Q", true));
            harassMenu.Add("HarassW1", new CheckBox("Use W", false));
            harassMenu.Add("HarassE1", new CheckBox("Use E", false));
            harassMenu.Add("HarassR", new CheckBox("Use R", true));
            ...
            miscMenu.Add("eactivated", new CheckBox("Use E"));
            miscMenu.Add("emyhp", new Slider("Player HP", 30, 0, 100));
            miscMenu.Add("eallyhp", new Slider("Ally HP", 30, 0, 100));
            miscMenu.Add("emana", new Slider("Minimum Mana % ", 50, 0, 100));
            ...
            fleeMenu.Add("fleee", new CheckBox("R + E Flee", true));
